    ...
    <section class="border-red-500 bg-gray-200 min-h-screen flex items-center justify-center">
      <div class="bg-gray-100 p-5 flex rounded-2xl shadow-lg max-w-3xl">
        <div class="md:w-1/2 px-5">
          <h2 class="text-2xl font-bold tracking- text-gray-500 text-center  ">Login</h2>
        ...
        <div class="w-1/2 md:block flex items-center justify-center">
          <img src="img/arsindo.png" class="rounded-2xl flex items-center justify-center mt-20" alt="page img">
        </div>
