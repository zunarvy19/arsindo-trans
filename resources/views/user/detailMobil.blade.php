  ...
  <div class="flex flex-row space-x-40">
    ...
    <div class="flex flex-col space-y-2">
      ...
      <div class="border border-slate-300 w-auto px-7 py-10 rounded-xl">
        <div class="flex justify-between">
          ...
          <a href="#" class="hover:underline text-blue-500">Clear all search</a>
        </div>
        <hr class="mx-auto border border-gray-300 my-3">
        <div>
          <p class="font-semibold ">Seats</p>
          <label for="" class="flex gap-x-2 items-center">
            <input type="checkbox" class="" checked class="">12
          </label>
          <label for="" class="flex gap-x-2 items-center">
            <input type="checkbox" class=""  class="">6
          </label>
          <label for="" class="flex gap-x-2 items-center">
            <input type="checkbox" class=""  class="">5
          </label>
          <label for="" class="flex gap-x-2 items-center">
            <input type="checkbox" class=""  class="">4
          </label>
        </div>
        <hr class="mx-auto border border-gray-300 my-3">
        <div>
          <p class="font-semibold ">Transmision</p>
          <label for="" class="flex gap-x-2 items-center">
            <input type="checkbox" class="" checked class="">Matic
          </label>
          <label for="" class="flex gap-x-2 items-center">
            <input type="checkbox" class=""  class="">Manual
          </label>
        </div>
      </div>
      {{-- filter search end --}}
    ...
    <div class="container flex flex-col space-y-10">
      ...
      <div class="flex flex-col ">
        <h1 class="text-2xl font-semibold">{{$dataMobil->count()}} Car Available</h1>
      ...
      <div class="container flex flex-col space-y-5">
        @foreach ($dataMobil as $item)
        <div class="flex flex-row border border-gray-400 rounded-xl container p-10 justify-around">
          <div>
            <img src="{{ asset('storage/' . $item->foto)}}" alt="" class="min-w-md w-96">
          </div>
          <div class="flex flex-col ">
            <div class="">
            ...
            <div class="grid grid-cols-2 gap-x-7 gap-y-7 my-10">
              ...
              <h1 class="flex items-center space-x-2 text-base">
                <span>
