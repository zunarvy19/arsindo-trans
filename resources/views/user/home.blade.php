...
{{-- Hero --}}
<section class="w-screen min-h-screen h-screen bg-center bg-cover bg-no-repeat opacity-95 bg-blend-multiply" style="background-image: url('/img/heroHome.png');" id="home">
  <div class="flex justify-center md:justify-start items-center md:items-cebter h-full bg-black bg-opacity-30">
    <div class="text-center md:text-start text-white md:ml-6 md:w-1/2 px-4 md:px-0">
    ...
    <div class="flex mt-[30rem]">
      <img src="/img/home.png" alt="Arsindo" class="w-[100rem] hidden md:flex">
    </div>
  </div>
</section>
{{-- Hero end --}}
...
<div class="flex justify-center py-36">
  ...
  <div class="md:flex md:justify-center md:items-center md:flex-row md:gap-x-20"> {{-- container --}}
...
<div class="flex justify-center my-10">
  ...
  <div class="flex justify-center items-center flex-col md:flex-row md:gap-x-20 ">
    <div class="grid md:grid-cols-3 md:gap-x-10 md:gap-y-8 mx-auto grid-cols-1 px-1 md:px-0 gap-y-10">
  ...
  <div class="flex flex-col space-y-16">
    ...
    <div class="flex flex-col md:flex-row items-center">
      ...
      <div class="w-full md:w-1/2 flex justify-center">
        <img src="/img/premio.png" alt="Toyota Hiace Premio" class="w-full max-w-sm md:max-w-none rounded-b-lg">
      </div>
      <!-- Konten -->
      <div class="w-full md:w-1/2 bg-tertiary px-8 py-12 md:p-20">
        <h1 class="text-4xl md:text-6xl text-white uppercase font-semibold">Toyota</h1>
        <h1 class="text-4xl md:text-6xl text-white uppercase my-6 md:my-10 font-semibold">HI ACE PREMIO</h1>
        <p class="text-lg md:text-xl text-white">
          Toyota Hiace dapat menampung antara 10 hingga 16 penumpang, tergantung pada model dan konfigurasi kursi.
        </p>
        <div class="flex justify-end mt-12">
          <a href="/detail-mobil" class="btn bg-primary text-white uppercase px-6 py-3 hover:bg-primary">
            Read More
            <span>
    ...
    <div class="flex flex-col md:flex-row-reverse items-center">
      <!-- Gambar -->
      <div class="w-full md:w-1/2 flex justify-center">
        <img src="/img/xl7.png" alt="Suzuki XL7 Hybrid" class="w-full max-w-sm md:max-w-none rounded-t-lg">
      </div>
      <!-- Konten -->
      <div class="w-full md:w-1/2 bg-[#889293] px-8 py-12 md:p-20">
        <h1 class="text-4xl md:text-6xl text-white uppercase font-semibold">Suzuki</h1>
        <h1 class="text-4xl md:text-6xl text-white uppercase my-6 md:my-10 font-semibold">XL-7 Hybrid</h1>
        <p class="text-lg md:text-xl text-white">
          Suzuki XL7 Hybrid memiliki kapasitas tempat duduk untuk 7 penumpang. Mobil ini dirancang sebagai SUV keluarga dengan konfigurasi tiga baris kursi, menawarkan ruang yang cukup bagi seluruh penumpang.
        </p>
        <div class="flex justify-start mt-12">
          <a href="/detail-mobil" class="btn bg-secondary text-white uppercase px-6 py-3 hover:bg-secondary">
            Read More
            <span>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 inline-block ml-2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
...
<div class="bg-secondary w-screen">
  <div class="container mx-auto flex flex-col md:flex-row justify-around items-center md:justify-center p-5">
    <!-- Words Section -->
    <div class="mx-auto text-center md:text-left">
      <h1 class="text-5xl md:text-6xl font-semibold text-white capitalize mb-6">What our <br>customer says</h1>
      <div class="flex justify-center md:justify-start">
        <a href="/cust-review">
          <button class="btn bg-primary border-none btn-wide text-xl text-white shadow-lg hover:bg-primary">
            View More
          </button>
        </a>
      </div>
        ...
        <div class="carousel-item h-full">
          <div class="w-[80%] h-fit mx-auto p-6 bg-white shadow-lg rounded-lg flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            <div class="flex-1">
              ...
              <p class="text-gray-600 mt-2">
                Berkendara dengan jasa ArsindoTours sangat seru dan dapat diandalkan dari segi teknis dan pelayanannya.
              </p>
            </div>
          </div>
        </div>
...
<div class="bg-primary w-screen min-h-screen ">
  ...
  <div class="flex flex-col justify-center items-center h-screen">
    ...
    <div class="mb-10 -mt-72">
      <h1 class="text-3xl md:text-5xl text-white font-bold text-center " id="faq">Frequenly Asked Questions</h1>
    </div>

    <div class="w-full max-w-screen-md px-5 md:px-0">


      @forelse ($faq as $faq)
      <!-- Accordion Item -->
      <div class="border-b border-slate-200 bg-white px-8 py-4 rounded-t mb-2">
        <button onclick="toggleAccordion({{$faq->id}})" class="w-full flex justify-between items-center py-4 text-slate-800">
        ...
        <div id="content-{{$faq->id}}" class="max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
          <div class="py-4 text-lg text-slate-500">
            {{$faq->answer}}
          </div>
        </div>
      </div>
      ...
      <div class="border-b border-slate-200 bg-white px-8 py-4 rounded-t mb-2">
        <button onclick="toggleAccordion(1)" class="w-full flex justify-between items-center py-4 text-slate-800">
          <span class="text-xl font-semibold">Apakah bisa rental tanpa supir?</span>
      ...
      <div class="border-b border-slate-200 bg-white px-8 py-4 rounded-t mb-2">
        <button onclick="toggleAccordion(2)" class="w-full flex justify-between items-center py-4 text-slate-800">
          <span class="text-xl font-semibold">Jika meminta waktu tambahan dalam waktu sewa?</span>
      ...
      <div class="border-b border-slate-200 bg-white px-8 py-4 rounded-t mb-2">
        <button onclick="toggleAccordion(3)" class="w-full flex justify-between items-center py-4 text-slate-800">
          <span class="text-xl font-semibold">Perlu apa untuk menyewa unit dan jasa?</span>
